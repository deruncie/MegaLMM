...
MegaLMM_state$Posterior$posteriorSample_params = c('Lambda','F_h2','B2_F','Lambda_pi','B2_F_pi')#,'Eta_mean')
```
...
n_iter = 10;  # how many samples to collect at once?
for(i  in 1:5) {
