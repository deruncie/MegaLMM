...
The data are based on data from the [Genomes To Fields Initiative](https://www.genomes2fields.org/) which is a large consortium grown maize hybrids across a large number of trials across North America, but have been anonymized.
...
Using the 15h map above might be a good option:
